...
export default function PhotoSwipeUI_Default(pswp, framework) {
        ...
        var _overlayUIUpdated = false,
            ...
            _defaultUIOptions = {
                ...
                getFilenameForShare: function (shareButtonData) {
                    return null;
                },
        ...
        var _onControlsTap = function (e) {
            ...
            _updateShareURLs = function () {
                ...
                for (var i = 0; i < _options.shareButtons.length; i++) {
                    ...
                    filename = _options.getFilenameForShare(shareButtonData);
                    ...
                    shareButtonOut += '<a href="' + shareURL + '" target="_blank" ' +
                        'class="pswp__button pswp__share--' + shareButtonData.id + '"' +
                        (shareButtonData.download ? 'download' + (filename ? '="' + filename + '"' : '') : '') + '>' +
                        (shareButtonData.fa ? '<i class="fa ' + shareButtonData.fa + '"></i>' : shareButtonData.label) + '</a>';

                    if (_options.parseShareButtonOut) {
                        shareButtonOut = _options.parseShareButtonOut(shareButtonData, shareButtonOut);
                    }
                }
                _shareButtons.innerHTML = shareButtonOut;

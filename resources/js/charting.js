...
export function fiveMeterSaves(stats) {
...
export function kickouts(stats) {
...
export function shootOutSaves(stats) {
...
export function shooting(stats) {
    if (stats.shots > 0) {
        return {
            data: [
                headerArray,
...
export function stealsToTurnovers(stats) {
...
export function thirstsQuenched(stats) {
    return {
        data: [
            headerArray,
            ['Thirsts', random(200, 500)],
            ['Quenched', 0]
        ]
    }
}

export function shirtsDelivered(stats) {
